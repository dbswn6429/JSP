...
<body>
	...
	<fmt:parseDate var="parsedTimeA" value="${timeA}" pattern="yyyy-MM-dd" />
	<fmt:formatDate var="formattedDate" value="${parsedTimeA}" pattern="yyyy년 MM월 dd일" />
