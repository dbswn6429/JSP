							...
							<ul class="reg_list">
								<li class="clear">
									...
									<div class="reg_content radio_area">
										<input type="radio" class="css-radio" id="mmm_lbl" name="gender" ${sessionScope.userDTO.gender == 'M' ? 'checked' : ''}><label for="mmm_lbl">남</label>
										<input type="radio" class="css-radio" id="www_lbl" name="gender" ${sessionScope.userDTO.gender == 'F' ? 'checked' : ''}><label for="www_lbl">여</label>
									</div>
								</li>
								<!-- 
								<li class="clear">
								...
								<li class="clear">
									...
									<div class="reg_content radio_area">
										<input type="radio" class="css-radio" id="smsyes_lbl" name="smsyesno" name="sns_yn" value="Y" ${sessionScope.userDTO.snsYn == 'Y' ? 'checked' : ''}><label for="smsyes_lbl">허용</label>
										<input type="radio" class="css-radio" id="smsno_lbl" name="smsyesno" name="sns_yn" value="N" ${sessionScope.userDTO.snsYn == 'N' ? 'checked' : ''}><label for="smsno_lbl">거부</label>
