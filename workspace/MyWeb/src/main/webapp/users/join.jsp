<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<!-- 
	required - 필수값
	pattern - 정규표현식 유효성 검사
	
	checked - 체크박스의 값을 미리 체크함
	selected - 셀렉트 태그의 값을 미리 선택함
			...
			<form action="joinForm.users" class="appForm" method="post">
				<fieldset>
					...
					<!-- 	<li class="clear">
							...
							<div class="app_content"><input type="password" class="w100p" id="pwd2_lbl" placeholder="비밀번호를 다시 한번 입력해주세요" name="pw_again"/></div>
						</li> -->
						<li class="clear">
							<label for="phone_lbl" class="tit_lbl pilsoo_item">연락처</label>
							<div class="app_content"><input type="tel" class="w100p" id="phone_lbl" placeholder="휴대폰 번호를 입력하세요" name="phone" pattern="[0-9]{3}-[0-9]{4}-[0-9]{4}" required/></div>
						</li>
						<li class="clear">
						...
						<li class="clear">
							...
							<div class="app_content checkbox_area">
								<input type="checkbox" class="css-checkbox" id="agree_lbl" name="sns_yn" value="Y" checked><label for="agree_lbl">동의함</label>
							</div>
						</li>
						<!-- <li class="clear">
					...
					<p class="btn_line"><input type="submit" class="btn_baseColor" value="등록">등록</p>	
				</fieldset>
			</form>
			<!-- //appForm -->
